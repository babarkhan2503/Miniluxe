...
<html lang="en">
    ...
    <body>
        ...
        <div style="margin-left: 3%;margin-bottom: 30px;height: 39px;margin-top: 3%;">
            <div style="float:left; width: 470px;">
                <div style="float:left; margin-right: 10px;font-size: 18px; font-weight: bold;">Tip Report: </div>
        ...
        <div style="margin-top: -1%;margin-left: 2.5%;">
            ...
            <span><input type="radio" name="colors" id="tip_report" value="true" class="changingbuttons"  style="margin-top: -4px;" checked="checked">  Tip Report</span>
    <!--        <span><button type="button" class="btn btn-primary"  style="margin-left: 33%;">Export to .cvs</button></span>-->
        ...
        <script>
                    var date = new Date();
                    var timeZone = -date.getTimezoneOffset(); //generate timeZone in mins
                    ...
                    $(document).ready(function()
                    {
                        ...
                        $('#example2').dataTable({
                            ...
                            "sAjaxSource": "searchtip.php?timeZone=" + timeZone + "&from=" + from + "&to=" + to,
                            dom: 'T<"clear">lfrtip',
                            tableTools: {
                                "aButtons": [
                                    {
