...
// b.engage_id,b.start_time,b.rating,b.total_cost,b.tip,d.technician_name,b.service_id
$aColumns = array("b.engage_id", "b.start_time", "b.rating","b.total_cost","b.tip","d.technician_name","b.service_id","b.end_time","e.web_name");
...
LIKE '%" . mysql_real_escape_string($_GET['sSearch']) . "%' OR ";
    ...
    $sWhere .= ") && (b.technician_id = d.technician_id) && (b.status =6) && (b.user_id=".$userId.")";
}
else
{
    $sWhere = "WHERE (b.technician_id = d.technician_id) && (b.status =6) && (b.user_id=".$userId.")";
}
...
$sQuery = "
		SELECT SQL_CALC_FOUND_ROWS b.engage_id,b.start_time,b.rating,b.total_cost,b.tip,d.technician_name,b.service_id,b.end_time,e.web_name FROM tb_engagements b, tb_technicians d, tb_locations e
		$sWhere
		$sOrder
		$sLimit
		";
...
$sQuery = "
		...
		FROM tb_engagements b, tb_technicians d , tb_locations e
                $sWhere
	";
...
$sqla = "SELECT  f.engage_id,a.service_name FROM tb_services a,tb_user_services f WHERE (f.service_id = a.id) && (f.user_id = ".$userId.")";
