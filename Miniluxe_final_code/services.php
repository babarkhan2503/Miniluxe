...
<html lang="en">
    ...
    <body>
        ...
        </span><span><input type="radio" name="colors" id="tip_report" value="" class="changingbuttons" style="margin-top: -4px;">  Tip Report</span>
    ...
    <script>
        ...
        $(document).ready(function()
        {
            ...
            $('#example2').dataTable({
                ...
                "sAjaxSource": "searchreport.php?timeZone=" + timeZone,
                dom: 'T<"clear">lfrtip',
                tableTools: {
                    "aButtons": [
                        {
...
//                        },
        ...
        // This event is triggered when user checked tip report radio button
